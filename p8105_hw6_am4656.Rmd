...
## Hypothetical Model
Hypothetically, predictors which may lead to or be protective against low birth weight include:
* family monthly income (`fincome`)
* gestational age in weeks (`gaweeks`)
* presence of malformations that could affect weight (`malform`)
